...
const routes: Route[] = [
  ...
  {path: RoutersApp.student, component: StudentRootComponent, // canActivate: [CanActiveVerifyLoginGuard],
    children: [
      {path: RoutersApp.schedule, component: StudentScheduleComponent},
      {path: RoutersApp.progress, component: StudentProgressComponent},
      {path: RoutersApp.medicalHistory, component: StudentMedicalHistoryComponent},
...
@NgModule({
  ...
  providers: [ServicePageHome, ServiceLogin],
